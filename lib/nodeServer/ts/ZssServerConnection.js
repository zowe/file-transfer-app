...
var httpEndpoint = '/unixfile/contents';
...
var ZssServerConnection = /** @class */ (function (_super) {
    ...
    ZssServerConnection.prototype.ls = function (path, handler) {
        ...
        httpRequest('GET', this.zssHost, this.zssPort, httpEndpoint + path, this.zssCookies, null, function (err, code, data, cookie) {
            if (!err) {
    ...
    ZssServerConnection.prototype.createReadStream = function (pathToFile, readyHandler, dataHandler, end) {
        var _this = this;
        httpRequest2('GET', this.zssHost, this.zssPort, httpEndpoint + pathToFile, this.zssCookies, null, function (writeStream, readStream) {
    ...
    ZssServerConnection.prototype.createWriteStream = function (pathToFile, readyHandler, end) {
        var _this = this;
        httpRequest2('POST', this.zssHost, this.zssPort, httpEndpoint + pathToFile, this.zssCookies, null, function (writeStream, readStream) {
            var streamId;
            if (writeStream) { //http request
