...
var TextInput = function (_mixin) {
  ...
  function TextInput(element, options) {
    ...
    var _this = possibleConstructorReturn(this, (TextInput.__proto__ || Object.getPrototypeOf(TextInput)).call(this, element, options));
